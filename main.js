...
document.getElementById("sketchtobedrawn").innerHTML = "Sketch to be drawn is " + sketch;
...
function gotresult(error, results){
    if(error){
        ...
        console.log(results);
        document.getElementById("updatep").innerHTML = "Your sketch : " + results[0].label;
        document.getElementById("confidenceofsketch").innerHTML = "Confidence : " + Math.floor(results[0].confidence*100) + "%";
    }
}
